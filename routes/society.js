...
router.post("/add/society",(request,response,next) =>{
    const{soc_name,soc_reg_no,soc_address_id,total_room,total_block,rooms_each_floor,total_shop}=request.body;

    pool.query('INSERT INTO society (soc_name,soc_reg_no,soc_address_id,total_room,total_block,rooms_each_floor,total_shop) VALUES ($1, $2,$3,$4,$5,$6,$7,)' ,
    [soc_name,soc_reg_no,soc_address_id,total_room,total_block,rooms_each_floor,total_shop],(err, res) =>{
