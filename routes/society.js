...
router.post("/add/society",async(request,response,next) =>{
  let soc_id =0;
    ...
    pool.query('INSERT INTO society (soc_name,soc_reg_no,soc_address_id,total_room,total_floor,total_block,rooms_each_floor,total_shop) VALUES ($1, $2,$3,$4,$5,$6,$7,$8) RETURNING *' ,
